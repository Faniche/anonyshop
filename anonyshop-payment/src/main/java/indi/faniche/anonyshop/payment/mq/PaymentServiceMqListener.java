package indi.faniche.anonyshop.payment.mq;

/* File:   PaymentServiceMqListener.java
 * -------------------------
 * Author: faniche
 * Date:   5/7/20
 */
...
//                System.out.println("已经支付成功，调用支付服务，修改支付信息和发送支付成功的队列");
                paymentService.updatePayment(paymentInfo, (String) resultMap.get("total_amount"), (Date) resultMap.get("payment_time"));
                return;
            }
        }
